...
Gomoku is an old Japanese game that is also popular in the Eastern Europe, where it's called "крестики и нолики". The game is simlar to "tic-tac-toe", but played on a board that's 15x15 or 19x19 squares. To win you must place five stonesin a row horizontally, vertically it diaganally.
